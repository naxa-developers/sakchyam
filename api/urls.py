...
urlpatterns = [
    ...
    path('automation/automation-data-province/', views.AutomationDataProvince.as_view({'get': 'list'}),
         name='automation-data-province'),
    path('automation/automation-data-municipality/', views.AutomationDataMunicipality.as_view({'get': 'list'}),
         name='automation-data-municipality'),
    path('automation/automation-data-partner/', views.AutomationDataPartner.as_view({'get': 'list'}),
         name='automation-data-partner'),
