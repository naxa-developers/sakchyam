...
from api.models import LogData, LogCategory, LogSubCategory, MilestoneYear, Automation, Partner, FinancialLiteracy, \
    Outreach, ProductProcess, Project, Product, Province, District, Municipality, \
    FinancialProgram, LogData, LogSubCategory, AutomationPartner, MFS, Insurance, SecondaryData, Partnership, Payment
